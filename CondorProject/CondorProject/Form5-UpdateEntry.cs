...
namespace CondorProject
{
    public partial class Form5_UpdateEntry : Form
    {
        ...
        public Form5_UpdateEntry(int visitorID, int id, int range, string from, string to)
        {
            InitializeComponent();
        ...
        {
            Hide();
            Form4_VisitorListResult form4 = new Form4_VisitorListResult(this.id, this.range, this.from, this.to);
